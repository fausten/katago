...
extern PROTOBUF_INTERNAL_EXPORT_onnx_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<3> scc_info_TypeProto_onnx_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_onnx_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_TypeProto_Opaque_onnx_2eproto;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<3> scc_info_TypeProto_onnx_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 3, 0, InitDefaultsscc_info_TypeProto_onnx_2eproto}, {
      &scc_info_TypeProto_Tensor_onnx_2eproto.base,
      &scc_info_TypeProto_SparseTensor_onnx_2eproto.base,
      &scc_info_TypeProto_Opaque_onnx_2eproto.base,}};

static void InitDefaultsscc_info_TypeProto_Opaque_onnx_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_TypeProto_Opaque_onnx_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_TypeProto_Opaque_onnx_2eproto}, {}};
...
// @@protoc_insertion_point(one_of_clear_start:onnx.SimpleShardedDimProto)
  switch (dim_case()) {
    ...
    case kDimParam: {
      dim_.dim_param_.Destroy(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
      break;
    }
    case DIM_NOT_SET: {
      break;
...
void TypeProto_Opaque::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_TypeProto_Opaque_onnx_2eproto.base);
  domain_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
